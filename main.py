...
def hash_simple(data: bytes, mask = BITS_32, fmt = fmt['8']) -> str:
...
s = 'navas.dev'
print(hash_simple(s.encode(), mask=BITS_32, fmt=fmt['8']))
print(hash_simple(s.encode(), mask=BITS_64, fmt=fmt['16']))
